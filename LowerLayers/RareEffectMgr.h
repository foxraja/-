...
enum eRareType
{
	...
	RARE_MAGIC_POWER		=45,	//	short	nMagic_power		//침藤겟롸궐	
...
public:
	...
	inline int	GetStaticRareMagic_power(const	STATICRAREEFFECT	&SR)	const{	return	SR.nMagic_power	;	} //침藤겟롸궐
	...
	inline int	GetStaticRareNature_power(const	STATICRAREEFFECT	&SR)	const{	return	SR.nNature_power;	} //加藤겟롸궐
