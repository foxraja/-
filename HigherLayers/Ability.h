...
public:
  ...
  WORD GetChar() const { return m_wCha; }
  WORD GetEndu() const { return m_wEndu; }
  WORD GetMove() const { return m_wMovp; }
  ...
  void SetChar(WORD wValue) { m_wCha = wValue; }
  void SetEndu(WORD wValue) { m_wEndu = wValue; }
  void SetMove(WORD wValue) { m_wMovp = wValue; }
