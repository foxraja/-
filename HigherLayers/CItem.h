...
public:
	...
	virtual int GetPlusMagic_power() const { return 0; } //°××°Ä§·¨¹¥»÷Á¦
...
//	virtual int CurrEquip(CHARLIST *ch ){ return 0; }	//020303 lsw
	...
	virtual int GetPlusMagic_power() const { return Magic_power; } //°××°Ä§·¨¹¥»÷Á¦
...
//	virtual int GetUseJunk() { return Use_Junk; }
	...
	virtual int GetPlusLife() const { return Change_Life_max; }
	virtual int GetPlusMana() const { return Change_mana_max; }
	virtual int GetClassMagic_power(){ return Magic_power;} //°××°Ä§·¨¹¥»÷Á¦
...
enum ItemPosType
{
	...
	MAKE		=6,
	OTHER_CH	=7,
	AUCTION_DB	=8//¾ÆÀÌÅÛ À§Ä¡°¡ ¿Á¼Ç µðºñ¿¡ ÀÖ´Ù 021030 lsw
};
...
extern int ConvBondMoneyCount(const DWORD dwMoney,const int iaBondIndex = 0);//µ·À» ³ÖÀ¸¸é ¹ÞÀ» º»µå¸Ó´Ï¿Í µ· ¾ÆÀÌÅÛÀÇ °¹¼ö¸¦ ¸®ÅÏ// iaBondIndex aBondMoneyÀÇ ÀÎµ¦½º¸¦ ÀÇ¹Ì
extern int GiveMoney(CHARLIST *ch, const DWORD dwMoney,const int iaBondIndex = 0);// iaBondIndex aBondMoneyÀÇ ÀÎµ¦½º¸¦ ÀÇ¹Ì
extern int GiveMoneyAble(CHARLIST *ch, const DWORD dwMoney,const int iaBondIndex = 0);//µ·À» ¹ÞÀ» ¼ö ÀÖ´Â »óÈ²ÀÎ°¡
