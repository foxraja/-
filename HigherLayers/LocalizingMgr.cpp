...
CLocalizingMgr::~CLocalizingMgr()
{
	SAFE_DELETE_ARRAY(m_pszNationName);
	SAFE_DELETE_ARRAY(m_pszTotalDbID);
	SAFE_DELETE_ARRAY(m_pszTotalDbPW);
	SAFE_DELETE_ARRAY(m_pszDragonDbID);
	SAFE_DELETE_ARRAY(m_pszDragonDbPW);
	SAFE_DELETE_ARRAY(m_pszChrlogDbID);
	SAFE_DELETE_ARRAY(m_pszChrlogDbPW);
}
