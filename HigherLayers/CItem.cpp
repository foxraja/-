...
//				virtual函数
//				该项目方案的导入从1号开始。
//				Num_Of_CItem_XXXXX用define的数量多少来读。
//				DB中项目的数量，Of Num - CItem XXXXX，比小。
//				DB中项目.读取??
// 
// 返回值：DB中实际的项目数量。
//
...
{										
	...
	e = count;					
	if( e > MAX_ITEM_LIST ) e = MAX_ITEM_LIST;		// 茄锅俊 MAX_ITEM_LIST/3沥档父 Check茄促. 为了减少服务器的负担.
...
// add money中使用的MAX MONEY小，比金钱和空间的函数		// 001030 YGI
